...
const EditProductForm = ({ product, closeEditModal, updateProduct }) => {
  ...
  const handleSubmit = (e) => {
    ...
    updateProduct(items.id, { name: items.name, price: items.price, description: items.description })
    .then(() => {
    ...
    <div>
      <form onSubmit={handleSubmit} action="POST">
        ...
        <div className="mb-2 mt-6 text-right">
          <button type="button" onClick={closeEditModal} className="text-gray-900 bg-white border border-gray-300 hover:bg-gray-200 focus:outline-none focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">Cancel</button>
